  ...
  return (
    <div>
      <Heading
        ...
        decription="Generate code snippets using descriptive text"
        icon={Code}
          ...
          <Form {...form}>
            ...
            >
              <FormField
                name="prompt"
                render={({ field }) => (
                  <FormItem className="col-span-11 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      <Input
                        className="border-0 outline-none focus-visible:right-0 focus-visible:ring-transparent"
                        disabled={isLoading}
                        placeholder="Simple carousel component using React."
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="flex flex-col-reverse gap-y-4">
            {messages.map((message) => (
              ...
              >
                {message.role === "user" ? <UserAvatar /> : <BrainAvatar />}
                <ReactMarkdown
                  components={{
                    pre: ({ node, ...props }) => (
